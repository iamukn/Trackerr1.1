...
"""
    ...
    def test_retrieve_all(self, verify_address):
        # retrieve all tracking generated by business owner
        verify_address.return_value = {'shipping_address': self.data['shipping_address'], 'country': 'Nigeria', 'city': 'Lagos', 'latitude': '34526','longitude': '3456'}

        url1 = reverse('generate-tracking')
        res1 = self.client.post(url1, data=self.data, format='json')
        verify_address.assert_called_once_with(self.data.get('shipping_address'))
