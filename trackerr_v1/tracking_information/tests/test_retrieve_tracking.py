...
class TestRetrieveAllTracking(APITestCase):
    ...
    def setUp(self):
        ...
        self.data = {'shipping_address': 'Lagos','product': 'shoe', 'quantity': 1, 'delivery_date': '2024-1-12'}
...
"""
    ...
    def test_retrieve_all(self, mock_verify_address,mock_track_gen):
        # retrieve all tracking generated by business owner
        mock_track_gen_instance = MagicMock()
      
        mock_track_gen_instance.generate_tracking.return_value = "JN123456789E"
        mock_verify_address.return_value = {'shipping_address': self.data['shipping_address'], 'country': 'Nigeria', 'city': 'Lagos', 'latitude': '34526','longitude': '3456'}
