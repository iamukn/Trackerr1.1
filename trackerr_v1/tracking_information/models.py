...
class Tracking_info(models.Model):
    ...
    destination_lat = models.CharField(max_length=255, null=True, blank=True, default=None)
    destination_lon = models.CharField(max_length=255, null=True, blank=True, default=None)
    rider = models.OneToOneField(Logistics_partner, on_delete=models.SET_NULL, null=True, blank=True, default=None)
