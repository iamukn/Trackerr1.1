...
class LogisticsRegistrationTest(TestCase):
    ...
    def test_can_inherit_logistic_partner_model(self):
        ...
        user = User.objects.create(name="Jane Doe", email='janedoe@gmail.com', phone_number='7037******', address='Lagos', account_type='Business', password='Hello world', country='ghana')
        user.save()
